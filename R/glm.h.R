...
glmOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "glmOptions",
...
glmResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
glmBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "glmBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,1,0),
                options = options,
                results = glmResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
glm <- function(
    ...
    if ( ! requireNamespace('jmvcore'))
        stop('glm requires jmvcore to be installed (restart may be required)')

    options <- glmOptions$new(
        dep = dep,
        factors = factors,
        covs = covs,
    ...
    results <- glmResults$new(
        options = options)

    analysis <- glmClass$new(
        options = options,
        data = data)
